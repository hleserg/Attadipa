...
- **The hourly watchdog had never started an agent, and nothing said so.**
  ...
  `.github/tests/watchdog-dispatch-actor-test.sh`, 12 assertions, run in CI,
  ...
  leading theory and was not the cause; it is now T-109 on its own merits.
