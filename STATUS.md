...
- **Two questions went to the owner**: [A9](docs/research/OPEN_QUESTIONS.md) —
  ...
  recorded as [OD-20](docs/research/OWNER_DECISIONS.md#od-20--a10-the-display-wakes-on-raise-button-or-touch-the-raise-gesture-reads-the-accelerometer-only):
...
- **A10 answered, and the schematic re-read that came with it closed an
  ...
  [OD-20](docs/research/OWNER_DECISIONS.md#od-20--a10-the-display-wakes-on-raise-button-or-touch-the-raise-gesture-reads-the-accelerometer-only).
