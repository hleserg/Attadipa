...
| ESP32-S3 firmware | **boots on the physical Waveshare unit** — T-165 links the existing host libraries, reports silicon/flash/PSRAM/partitions/heap and emits a heartbeat; no display, touch, PMU or RTC driver yet |
| Hardware tests | **T-165 measured:** flash and PURE_RAM boot, 32 MB physical flash under a 16 MB build ceiling, 8 MB octal PSRAM and the development partition table. Every other HIL plan remains `NOT EXECUTED — HARDWARE REQUIRED` — [HIL_PLANS](docs/testing/HIL_PLANS.md) |
...
T-004 chose and pinned ESP-IDF v5.5.5; T-165 now builds both firmware variants
with it locally and in CI.

## Hardware measurements and pending tests

The Waveshare unit has been powered, probed and booted with Attadipa T-165; the
measured boundary is recorded below and in
[BRINGUP_2026-08-25](docs/hardware/BRINGUP_2026-08-25.md). Display, touch, PMU,
RTC, power, timing, GNSS, radio, interference and sleep/wake remain
