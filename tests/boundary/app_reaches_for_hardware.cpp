...
//
// Linked against firefly_platform it compiles, and linked against firefly_apps
...
int main()
{
    ...
    const auto feature = firefly::platform::HardwareFeature::Radio;
    return firefly::platform::to_string(feature) == nullptr ? 1 : 0;
}
