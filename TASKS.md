...
- **Priority:** P2
- **Dependencies:** T-127 (**done**) — the script it runs is committed.
...
### T-127 · The generated asset checks never looked at the generated bytes — **DONE** 2026-08-23
...
- **The staleness gate covers the converter as well as the art.** An encoder
  ...
  a hand-edited mask passed — **T-127** closed that, and `INPUTS.sha256` now
