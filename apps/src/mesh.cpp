...
// `core/include/attadipa/core/mesh_service.h:179` — "    // WHICH NODE THIS WATCH IS PINNED TO, AND THE LAST ONE IT TURNED AWAY."
//
...
// (`link/src/meshcore_companion.cpp:185` — "    // `status_.pinned_id` and `status_.refused_id` are deliberately NOT cleared"),
...
StringId delivery_word(MeshDelivery delivery) {
    ...
    case MeshDelivery::Unconfirmed: return StringId::MeshDeliveryUnconfirmed;
    case MeshDelivery::Refused:   return StringId::MeshDeliveryRefused;
    case MeshDelivery::Unknown:   return StringId::MeshDeliveryUnknown;
    }
