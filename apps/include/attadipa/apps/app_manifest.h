...
// attadipa::platform from this library — not by convention, but because the
// link line does not include it (docs/adr/0007-two-capability-layers.md §5). An
...
struct AppManifest {
  ...
  // Applications declare cadence; the composition root owns the timer.
  // Zero means event-driven only.
  core::Millis tick_period{};
};
...
LauncherEntry launcher_entry(const AppManifest &manifest,
