 ...
 * at 96 px, 4 bpp. SIL Open Font License 1.1 — assets/fonts/OFL.txt.
 *
 ...
 * Size: 96 px
 * Bpp: 4
 * Opts: --font /mnt/e/projects/firefly/build-attadipa-sim-wsl/_deps/lvgl-src/scripts/built_in_font/Montserrat-Medium.ttf --size 96 --bpp 4 --format lvgl --no-compress --lv-include lvgl.h -o /mnt/e/projects/firefly/assets/fonts/generated/attadipa_montserrat_num_96.c --range 0x0030-0x003A --range 0x002D --range 0x002E --range 0x00B0
 ******************************************************************************/
...
#ifndef ATTADIPA_MONTSERRAT_NUM_96
#define ATTADIPA_MONTSERRAT_NUM_96 1
#endif

#if ATTADIPA_MONTSERRAT_NUM_96
...
static const lv_font_fmt_txt_glyph_dsc_t glyph_dsc[] = {
    ...
    {.bitmap_index = 206, .adv_w = 1025, .box_w = 56, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 2138, .adv_w = 568, .box_w = 26, .box_h = 67, .ofs_x = 0, .ofs_y = 0},
    {.bitmap_index = 3009, .adv_w = 882, .box_w = 51, .box_h = 68, .ofs_x = 1, .ofs_y = 0},
    {.bitmap_index = 4743, .adv_w = 879, .box_w = 51, .box_h = 68, .ofs_x = 0, .ofs_y = -1},
    {.bitmap_index = 6477, .adv_w = 1028, .box_w = 61, .box_h = 67, .ofs_x = 3, .ofs_y = 0},
    {.bitmap_index = 8521, .adv_w = 882, .box_w = 51, .box_h = 68, .ofs_x = 1, .ofs_y = -1},
    {.bitmap_index = 10255, .adv_w = 948, .box_w = 53, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 12084, .adv_w = 919, .box_w = 52, .box_h = 67, .ofs_x = 2, .ofs_y = 0},
    {.bitmap_index = 13826, .adv_w = 989, .box_w = 54, .box_h = 69, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 15689, .adv_w = 948, .box_w = 53, .box_h = 69, .ofs_x = 2, .ofs_y = -1},
    {.bitmap_index = 17518, .adv_w = 349, .box_w = 14, .box_h = 52, .ofs_x = 4, .ofs_y = -1},
    {.bitmap_index = 17882, .adv_w = 644, .box_w = 32, .box_h = 31, .ofs_x = 4, .ofs_y = 36}
};
...
static const int8_t kern_class_values[] =
{
    ...
    -15, 0, 0, 0, 0, -11, 0, -18,
    -20, 15, 15, -14, 0, -20, 15, 0,
    0, -97, 11, -18, 0, -5, -5, -15,
    0, 0, -11, 0, 0, 0, 5, -11,
    15, -5, 0, 0, 0, -29, 0, -5,
    0, 0, 0, 0, 0, 0, 0, 0,
    -8, -8, 0, -15, -18, 0, 0, 0,
    -23, 15, 31, 0, -38, -5, -18, 0,
    -5, -72, 15, -11, 11, -46, 0, 0,
    0, 0, -8, -8, 0, -8, -20, 0,
    0, 0, -18, 8, 15, 0, 0, 0,
    0, 0, 0, -11, 0, 0, 0, -29,
...
#if LVGL_VERSION_MAJOR >= 8
const lv_font_t attadipa_montserrat_num_96 = {
#else
lv_font_t attadipa_montserrat_num_96 = {
#endif
...
#endif /*#if ATTADIPA_MONTSERRAT_NUM_96*/
