...
void print_usage(const char *argv0) {
  std::printf(
      ...
      "screen\n"
      "  --clock          show the Clock instead of the capability screen; it "
      "follows\n"
      "                   this host's local wall time, TZ and all\n"
      "  --clock-time <s> fixed UNIX seconds, drawn as written whatever TZ "
      "says,\n"
      "                   for a deterministic Clock screenshot\n"
      ...
      "  --nav-state <name> ready, waiting, no-fix, own-stale, own-degraded,\n"
      "                   receiver-silent, node-unavailable, node-unknown,\n"
