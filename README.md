...
| | |
|---|---|
| **Builds and is tested on a host** | seven libraries, the desktop simulator and **32 tests**, under GCC and Clang, under `-Werror` and under ASan+UBSan. Two of them compile one fixture against two different libraries to prove an application still cannot include a hardware header |
