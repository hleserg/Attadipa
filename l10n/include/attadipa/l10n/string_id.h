...
enum class StringId : std::uint16_t {
    ...
    No = 140,
    ProductName = 141,
    ProvisionCancelled = 142,
    ProvisionDone = 143,
    ProvisionFailed = 144,
    ProvisionForgottenSkipped = 145,
    ProvisionHintDate = 146,
    ProvisionHintNode = 147,
    ProvisionHintOffset = 148,
    ProvisionHintPasskey = 149,
    ProvisionHintTime = 150,
    ProvisionKeyCancel = 151,
    ProvisionKeyErase = 152,
    ProvisionKeyForget = 153,
    ProvisionKeyOk = 154,
    ProvisionNodeForgotten = 155,
    ProvisionNodeForgottenRam = 156,
    ProvisionNodeKept = 157,
    ProvisionNodeNothing = 158,
    ProvisionNodePending = 159,
    ProvisionNodeReplayInhibited = 160,
    ProvisionPending = 161,
    ProvisionRejected = 162,
    ProvisionSkipped = 163,
    ProvisionTitleDate = 164,
    ProvisionTitleDone = 165,
    ProvisionTitleNode = 166,
    ProvisionTitleOffset = 167,
    ProvisionTitlePasskey = 168,
    ProvisionTitleTime = 169,
    RadioChipUnknown = 170,
    Yes = 171,
};
inline constexpr std::uint16_t kStringIdCount = 172;
