...
enum class StringId : std::uint16_t {
    ...
    ProvisionDone = 83,
    ProvisionFailed = 84,
    ProvisionForgottenSkipped = 85,
    ProvisionHintDate = 86,
    ProvisionHintNode = 87,
    ProvisionHintOffset = 88,
    ProvisionHintPasskey = 89,
    ProvisionHintTime = 90,
    ProvisionKeyCancel = 91,
    ProvisionKeyErase = 92,
    ProvisionKeyForget = 93,
    ProvisionKeyOk = 94,
    ProvisionNodeForgotten = 95,
    ProvisionNodeForgottenRam = 96,
    ProvisionNodeKept = 97,
    ProvisionNodeNothing = 98,
    ProvisionNodePending = 99,
    ProvisionPending = 100,
    ProvisionRejected = 101,
    ProvisionSkipped = 102,
    ProvisionTitleDate = 103,
    ProvisionTitleDone = 104,
    ProvisionTitleNode = 105,
    ProvisionTitleOffset = 106,
    ProvisionTitlePasskey = 107,
    ProvisionTitleTime = 108,
    RadioChipUnknown = 109,
    Yes = 110,
};
inline constexpr std::uint16_t kStringIdCount = 111;
