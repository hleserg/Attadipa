...
enum class StringId : std::uint16_t {
    ...
    ProvisionPasskeyUncertain = 167,
    ProvisionPending = 168,
    ProvisionRejected = 169,
    ProvisionTimeSaved = 170,
    ProvisionTimeUncertain = 171,
    ProvisionTitleDay = 172,
    ProvisionTitleForget = 173,
    ProvisionTitleHour = 174,
    ProvisionTitleMinute = 175,
    ProvisionTitleMonth = 176,
    ProvisionTitleNode = 177,
    ProvisionTitleOffset = 178,
    ProvisionTitlePasskey = 179,
    ProvisionTitleReceipt = 180,
    ProvisionTitleReview = 181,
    ProvisionTitleYear = 182,
    RadioChipUnknown = 183,
    Yes = 184,
};
inline constexpr std::uint16_t kStringIdCount = 185;
