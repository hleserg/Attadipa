#ifndef FIREFLY_L10N_LOCALE_H
#define FIREFLY_L10N_LOCALE_H

#include <cstdint>

namespace firefly::l10n {

// The locales Firefly ships. Final §50 makes English and Russian a product
