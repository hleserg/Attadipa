...
`link/src/meshcore_companion.cpp:1104` — "        if (size < 148) { ++malformed_frames_; return false; }".
...
`link/src/meshcore_companion.cpp:767` — "        copy_text(status_.last_message, &data[text], size - text);" —
