...
([`core/include/attadipa/core/power_owner.h:339`](../../core/include/attadipa/core/power_owner.h) —
...
(`core/include/attadipa/core/power_owner.h:348` — "// That decision is made, in ADR-0016: such a consumer does not call `acquire()`").
