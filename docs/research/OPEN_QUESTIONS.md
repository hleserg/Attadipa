...
Opened 2026-09-03 by [#422](https://github.com/hleserg/Attadipa/issues/422); the desk pass that raised them is [TWATCH_RTC_INPUT_WAKE](TWATCH_RTC_INPUT_WAKE.md), whose §4 is the procedure and whose step each row names.
