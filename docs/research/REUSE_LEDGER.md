...
`physical_input.cpp:566` — "start_physical_input(esp_lcd_touch_handle_t touch"
— takes exactly those.
...
- [`../../firmware/main/meshcore_forget_outcome.h:59`](../../firmware/main/meshcore_forget_outcome.h)
  ...
  ([`../../firmware/main/meshcore_passkey_outcome.h:82`](../../firmware/main/meshcore_passkey_outcome.h)
...
- The worker's `ForgetBond` event —
  [`../../firmware/main/meshcore_ble.cpp:1977`](../../firmware/main/meshcore_ble.cpp)
...
ends itself instead — `firmware/main/meshcore_ble.cpp:2188` — "    vTaskDelete(nullptr);".
