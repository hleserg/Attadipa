...
`Copyright (c) 2025 Project Contributors`. That repository's own README
agrees in prose (written without a line number: it names a file in *another*
project, and `check_docs.py` resolves such a citation against this one).
