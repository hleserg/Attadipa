...
[`firmware/main/meshcore_ble.cpp:970`](../../firmware/main/meshcore_ble.cpp) —
...
passkey. That sets
[`firmware/main/meshcore_ble.cpp:1774`](../../firmware/main/meshcore_ble.cpp) —
...
[`firmware/main/meshcore_ble.cpp:1871`](../../firmware/main/meshcore_ble.cpp) —
...
confirm value, [`firmware/main/meshcore_ble.cpp:672`](../../firmware/main/meshcore_ble.cpp) —
...
`store_node_pin()` — [`firmware/main/meshcore_ble.cpp:475`](../../firmware/main/meshcore_ble.cpp) —
...
1. A recovery that *replays* the stored passkey is wrong: it is stale the
   ...
   [`firmware/main/meshcore_ble.cpp:1320`](../../firmware/main/meshcore_ble.cpp) —
...
- *The NVS eraser is a crash-recovery guard, not what makes the clear take
  ...
  [`firmware/main/meshcore_ble.cpp:2250`](../../firmware/main/meshcore_ble.cpp) —
...
- *Between the clear and the adoption the watch is unpinned*, in the state
  [`firmware/main/meshcore_ble.cpp:2267`](../../firmware/main/meshcore_ble.cpp) —
...
([`../../firmware/main/meshcore_ble.cpp:1768`](../../firmware/main/meshcore_ble.cpp) —
