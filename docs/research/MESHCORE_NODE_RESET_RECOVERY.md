...
[`firmware/main/meshcore_ble.cpp:978`](../../firmware/main/meshcore_ble.cpp) —
...
passkey. That sets
[`firmware/main/meshcore_ble.cpp:1783`](../../firmware/main/meshcore_ble.cpp) —
...
[`firmware/main/meshcore_ble.cpp:1880`](../../firmware/main/meshcore_ble.cpp) —
...
[`firmware/main/meshcore_ble.cpp:2089`](../../firmware/main/meshcore_ble.cpp) —
...
confirm value, [`firmware/main/meshcore_ble.cpp:680`](../../firmware/main/meshcore_ble.cpp) —
...
`store_node_pin()` — [`firmware/main/meshcore_ble.cpp:483`](../../firmware/main/meshcore_ble.cpp) —
...
1. A recovery that *replays* the stored passkey is wrong: it is stale the
   ...
   replaces the value —
   [`firmware/main/meshcore_ble.cpp:448`](../../firmware/main/meshcore_ble.cpp) —
   ...
   [`firmware/main/meshcore_ble.cpp:2194`](../../firmware/main/meshcore_ble.cpp) —
   "no MeshCore passkey stored; BLE stays unconfigured", and
   [`firmware/main/meshcore_ble.cpp:1328`](../../firmware/main/meshcore_ble.cpp) —
...
- *The NVS eraser is a crash-recovery guard, not what makes the clear take
  ...
  [`firmware/main/meshcore_ble.cpp:2260`](../../firmware/main/meshcore_ble.cpp) —
...
- *Between the clear and the adoption the watch is unpinned*, in the state
  [`firmware/main/meshcore_ble.cpp:2277`](../../firmware/main/meshcore_ble.cpp) —
...
([`../../firmware/main/meshcore_ble.cpp:418`](../../firmware/main/meshcore_ble.cpp) —
...
([`../../firmware/main/meshcore_passkey.h:89`](../../firmware/main/meshcore_passkey.h) —
