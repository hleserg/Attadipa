...
| The stored passkey | NVS, [`firmware/main/meshcore_ble.cpp:292`](../../firmware/main/meshcore_ble.cpp) — "constexpr const char* kPasskeyNvsKey" | untouched | **yes**, replayed at boot: [`firmware/main/meshcore_ble.cpp:2496`](../../firmware/main/meshcore_ble.cpp) — "restore_passkey();" |
...
passkey. That sets
[`firmware/main/meshcore_ble.cpp:1932`](../../firmware/main/meshcore_ble.cpp) —
"configured.store(true);" and
[`firmware/main/meshcore_ble.cpp:1934`](../../firmware/main/meshcore_ble.cpp) —
...
[`firmware/main/meshcore_ble.cpp:2071`](../../firmware/main/meshcore_ble.cpp) —
"const int deleted = ble_store_util_delete_peer(&address);" and re-arms one
attempt at [`firmware/main/meshcore_ble.cpp:2107`](../../firmware/main/meshcore_ble.cpp) —
...
[`firmware/main/meshcore_ble.cpp:2289`](../../firmware/main/meshcore_ble.cpp) —
...
that one — [`firmware/main/meshcore_ble.cpp:1984`](../../firmware/main/meshcore_ble.cpp) —
...
1. A recovery that *replays* the stored passkey is wrong: it is stale the
   ...
   [`firmware/main/meshcore_ble.cpp:2394`](../../firmware/main/meshcore_ble.cpp) —
...
- *The NVS eraser is a crash-recovery guard, not what makes the clear take
  ...
  [`firmware/main/meshcore_ble.cpp:2464`](../../firmware/main/meshcore_ble.cpp) —
...
- *Between the clear and the adoption the watch is unpinned*, in the state
  [`firmware/main/meshcore_ble.cpp:2481`](../../firmware/main/meshcore_ble.cpp) —
