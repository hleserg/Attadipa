...
[`firmware/main/meshcore_ble.cpp:1068`](../../firmware/main/meshcore_ble.cpp) —
"BLE_HS_HCI_ERR(BLE_ERR_PINKEY_MISSING)) {", which calls
[`firmware/main/meshcore_ble.cpp:1069`](../../firmware/main/meshcore_ble.cpp) —
"(void)record_stale_bond(event->enc_change.conn_handle," and then falls into
[`firmware/main/meshcore_ble.cpp:1072`](../../firmware/main/meshcore_ble.cpp) —
...
| The pinned node public key | NVS, `attadipa_mesh` / [`firmware/main/meshcore_ble.cpp:287`](../../firmware/main/meshcore_ble.cpp) — "constexpr const char* kNodeKeyNvsKey" | **untouched, and untouchable** — section 4 | **yes** |
| The stored passkey | NVS, [`firmware/main/meshcore_ble.cpp:290`](../../firmware/main/meshcore_ble.cpp) — "constexpr const char* kPasskeyNvsKey" | untouched | **yes**, replayed at boot: [`firmware/main/meshcore_ble.cpp:2453`](../../firmware/main/meshcore_ble.cpp) — "restore_passkey();" |
| `reconnect_allowed` | RAM atomic | cleared: [`firmware/main/meshcore_ble.cpp:766`](../../firmware/main/meshcore_ble.cpp) — "reconnect_allowed.store(false);" inside `disconnect_fault()`. This is the fail-closed stop | **no** |
...
passkey. That sets
[`firmware/main/meshcore_ble.cpp:1925`](../../firmware/main/meshcore_ble.cpp) —
"configured.store(true);" and
[`firmware/main/meshcore_ble.cpp:1926`](../../firmware/main/meshcore_ble.cpp) —
"reconnect_allowed.store(true);", and scanning resumes. The watch connects,
sees `secure_pairing` at
[`firmware/main/meshcore_ble.cpp:1047`](../../firmware/main/meshcore_ble.cpp) — "if (secure_pairing.load()) {",
...
attempt at [`firmware/main/meshcore_ble.cpp:2072`](../../firmware/main/meshcore_ble.cpp) —
...
[`firmware/main/meshcore_ble.cpp:2246`](../../firmware/main/meshcore_ble.cpp) —
...
confirm value, [`firmware/main/meshcore_ble.cpp:766`](../../firmware/main/meshcore_ble.cpp) —
...
`store_node_pin()` — [`firmware/main/meshcore_ble.cpp:552`](../../firmware/main/meshcore_ble.cpp) —
...
[`firmware/main/meshcore_ble.cpp:520`](../../firmware/main/meshcore_ble.cpp) —
"esp_err_t err = nvs_erase_key(handle, kPasskeyNvsKey);". `Deconfigure` calls
that one — [`firmware/main/meshcore_ble.cpp:1976`](../../firmware/main/meshcore_ble.cpp) —
...
- [`firmware/main/meshcore_ble.cpp:279`](../../firmware/main/meshcore_ble.cpp) —
...
1. A recovery that *replays* the stored passkey is wrong: it is stale the
   ...
   replaces the value —
   [`firmware/main/meshcore_ble.cpp:481`](../../firmware/main/meshcore_ble.cpp) —
   ...
   [`firmware/main/meshcore_ble.cpp:2351`](../../firmware/main/meshcore_ble.cpp) —
   "no MeshCore passkey stored; BLE stays unconfigured", and
   [`firmware/main/meshcore_ble.cpp:1422`](../../firmware/main/meshcore_ble.cpp) —
...
- *The NVS eraser is a crash-recovery guard, not what makes the clear take
  ...
  [`firmware/main/meshcore_ble.cpp:2421`](../../firmware/main/meshcore_ble.cpp) —
...
- *Between the clear and the adoption the watch is unpinned*, in the state
  [`firmware/main/meshcore_ble.cpp:2438`](../../firmware/main/meshcore_ble.cpp) —
...
([`../../firmware/main/meshcore_ble.cpp:473`](../../firmware/main/meshcore_ble.cpp) —
