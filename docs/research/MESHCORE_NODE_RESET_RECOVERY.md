...
[`firmware/main/meshcore_ble.cpp:1130`](../../firmware/main/meshcore_ble.cpp) —
"BLE_HS_HCI_ERR(BLE_ERR_PINKEY_MISSING)) {", which calls
[`firmware/main/meshcore_ble.cpp:1131`](../../firmware/main/meshcore_ble.cpp) —
"(void)record_stale_bond(event->enc_change.conn_handle," and then falls into
[`firmware/main/meshcore_ble.cpp:879`](../../firmware/main/meshcore_ble.cpp) —
...
| The stored passkey | NVS, [`firmware/main/meshcore_ble.cpp:292`](../../firmware/main/meshcore_ble.cpp) — "constexpr const char* kPasskeyNvsKey" | untouched | **yes**, replayed at boot: [`firmware/main/meshcore_ble.cpp:2574`](../../firmware/main/meshcore_ble.cpp) — "restore_passkey();" |
| `reconnect_allowed` | RAM atomic | cleared: [`firmware/main/meshcore_ble.cpp:828`](../../firmware/main/meshcore_ble.cpp) — "reconnect_allowed.store(false);" inside `disconnect_fault()`. This is the fail-closed stop | **no** |
...
passkey. That sets
[`firmware/main/meshcore_ble.cpp:1991`](../../firmware/main/meshcore_ble.cpp) —
"configured.store(true);" and
[`firmware/main/meshcore_ble.cpp:1993`](../../firmware/main/meshcore_ble.cpp) —
"reconnect_allowed.store(true);", and scanning resumes. The watch connects,
sees `secure_pairing` at
[`firmware/main/meshcore_ble.cpp:1109`](../../firmware/main/meshcore_ble.cpp) — "if (secure_pairing.load()) {",
...
[`firmware/main/meshcore_ble.cpp:2125`](../../firmware/main/meshcore_ble.cpp) —
"const int deleted = ble_store_util_delete_peer(&address);" and re-arms one
attempt at [`firmware/main/meshcore_ble.cpp:2163`](../../firmware/main/meshcore_ble.cpp) —
...
[`firmware/main/meshcore_ble.cpp:2367`](../../firmware/main/meshcore_ble.cpp) —
...
confirm value, [`firmware/main/meshcore_ble.cpp:828`](../../firmware/main/meshcore_ble.cpp) —
...
that one — [`firmware/main/meshcore_ble.cpp:2044`](../../firmware/main/meshcore_ble.cpp) —
...
1. A recovery that *replays* the stored passkey is wrong: it is stale the
   ...
   [`firmware/main/meshcore_ble.cpp:2472`](../../firmware/main/meshcore_ble.cpp) —
   "no MeshCore passkey stored; BLE stays unconfigured", and
   [`firmware/main/meshcore_ble.cpp:1484`](../../firmware/main/meshcore_ble.cpp) —
...
- *The NVS eraser is a crash-recovery guard, not what makes the clear take
  ...
  [`firmware/main/meshcore_ble.cpp:2542`](../../firmware/main/meshcore_ble.cpp) —
...
- *Between the clear and the adoption the watch is unpinned*, in the state
  [`firmware/main/meshcore_ble.cpp:2559`](../../firmware/main/meshcore_ble.cpp) —
...
[`../../firmware/main/meshcore_node_forget.h:183`](../../firmware/main/meshcore_node_forget.h) —
...
([`../../firmware/main/meshcore_node_forget.h:189`](../../firmware/main/meshcore_node_forget.h) —
