...
[`firmware/main/meshcore_ble.cpp:1843`](../../firmware/main/meshcore_ble.cpp) —
...
[`firmware/main/meshcore_ble.cpp:2042`](../../firmware/main/meshcore_ble.cpp) —
...
- [`link/src/meshcore_companion.cpp:1333`](../../link/src/meshcore_companion.cpp) —
...
1. A recovery that *replays* the stored passkey is wrong: it is stale the
   ...
   [`firmware/main/meshcore_ble.cpp:2111`](../../firmware/main/meshcore_ble.cpp) —
...
- *The NVS eraser is a crash-recovery guard, not what makes the clear take
  ...
  [`firmware/main/meshcore_ble.cpp:2176`](../../firmware/main/meshcore_ble.cpp) —
...
- *Between the clear and the adoption the watch is unpinned*, in the state
  [`firmware/main/meshcore_ble.cpp:2193`](../../firmware/main/meshcore_ble.cpp) —
...
([`../../firmware/main/meshcore_ble.cpp:1740`](../../firmware/main/meshcore_ble.cpp) —
