...
[`firmware/main/meshcore_ble.cpp:1070`](../../firmware/main/meshcore_ble.cpp) —
"BLE_HS_HCI_ERR(BLE_ERR_PINKEY_MISSING)) {", which calls
[`firmware/main/meshcore_ble.cpp:1071`](../../firmware/main/meshcore_ble.cpp) —
"(void)record_stale_bond(event->enc_change.conn_handle," and then falls into
[`firmware/main/meshcore_ble.cpp:1074`](../../firmware/main/meshcore_ble.cpp) —
...
| The stored passkey | NVS, [`firmware/main/meshcore_ble.cpp:292`](../../firmware/main/meshcore_ble.cpp) — "constexpr const char* kPasskeyNvsKey" | untouched | **yes**, replayed at boot: [`firmware/main/meshcore_ble.cpp:2502`](../../firmware/main/meshcore_ble.cpp) — "restore_passkey();" |
| `reconnect_allowed` | RAM atomic | cleared: [`firmware/main/meshcore_ble.cpp:768`](../../firmware/main/meshcore_ble.cpp) — "reconnect_allowed.store(false);" inside `disconnect_fault()`. This is the fail-closed stop | **no** |
...
passkey. That sets
[`firmware/main/meshcore_ble.cpp:1933`](../../firmware/main/meshcore_ble.cpp) —
...
[`firmware/main/meshcore_ble.cpp:1049`](../../firmware/main/meshcore_ble.cpp) — "if (secure_pairing.load()) {",
...
[`firmware/main/meshcore_ble.cpp:2072`](../../firmware/main/meshcore_ble.cpp) —
"const int deleted = ble_store_util_delete_peer(&address);" and re-arms one
attempt at [`firmware/main/meshcore_ble.cpp:2110`](../../firmware/main/meshcore_ble.cpp) —
...
[`firmware/main/meshcore_ble.cpp:2295`](../../firmware/main/meshcore_ble.cpp) —
...
confirm value, [`firmware/main/meshcore_ble.cpp:768`](../../firmware/main/meshcore_ble.cpp) —
...
`store_node_pin()` — [`firmware/main/meshcore_ble.cpp:554`](../../firmware/main/meshcore_ble.cpp) —
...
that one — [`firmware/main/meshcore_ble.cpp:1985`](../../firmware/main/meshcore_ble.cpp) —
...
1. A recovery that *replays* the stored passkey is wrong: it is stale the
   ...
   [`firmware/main/meshcore_ble.cpp:2400`](../../firmware/main/meshcore_ble.cpp) —
   "no MeshCore passkey stored; BLE stays unconfigured", and
   [`firmware/main/meshcore_ble.cpp:1424`](../../firmware/main/meshcore_ble.cpp) —
...
- *The NVS eraser is a crash-recovery guard, not what makes the clear take
  ...
  [`firmware/main/meshcore_ble.cpp:2470`](../../firmware/main/meshcore_ble.cpp) —
...
- *Between the clear and the adoption the watch is unpinned*, in the state
  [`firmware/main/meshcore_ble.cpp:2487`](../../firmware/main/meshcore_ble.cpp) —
...
not armed after a power loss; an owner-entered replacement raises the same
marker, commits, and only then removes it
([`../../firmware/main/meshcore_passkey.h:99`](../../firmware/main/meshcore_passkey.h) —
...
[`docs/adr/0018-owner-consent-for-provisioning.md:81`](../adr/0018-owner-consent-for-provisioning.md) —
