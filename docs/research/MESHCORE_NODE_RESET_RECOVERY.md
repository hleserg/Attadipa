...
- *Between the clear and the adoption the watch is unpinned*, in the state
  ...
  node's own screen
  ([`../../apps/src/provisioning.cpp:810`](../../apps/src/provisioning.cpp) —
