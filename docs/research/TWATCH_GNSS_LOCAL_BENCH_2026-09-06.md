...
- `gnss/src/nmea_receiver.cpp:501` — "if (!heard_) return Availability::Unreachable;"
...
- `gnss/src/nmea_receiver.cpp:422` — "open_.source = core::PositionSource::LocalGnss;"
- `gnss/src/nmea_receiver.cpp:263` — "close_epoch();"
- `gnss/src/nmea_receiver.cpp:409` — "close_epoch();"
...
- `gnss/src/nmea_receiver.cpp:502` — "core::elapsed(last_sentence_, now_) < silence_after_"
