...
- `gnss/src/nmea_receiver.cpp:240` — "if (!minmea_check(line_, true)) {"
- `gnss/src/nmea_receiver.cpp:245` — "heard_ = true;"
- `gnss/src/nmea_receiver.cpp:468` — "if (!heard_) return Availability::Unreachable;"
...
- `gnss/src/nmea_receiver.cpp:266` — "open_.source = core::PositionSource::LocalGnss;"
- `gnss/src/nmea_receiver.cpp:262` — "close_epoch();"
...
- `gnss/src/nmea_receiver.cpp:469` — "core::elapsed(last_sentence_, now_) < silence_after_"
- `gnss/src/nmea_receiver.cpp:181` — "now_ = now;"
