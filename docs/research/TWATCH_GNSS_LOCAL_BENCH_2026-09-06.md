...
- `gnss/src/nmea_receiver.cpp:474` — "if (!heard_) return Availability::Unreachable;"
...
- `gnss/src/nmea_receiver.cpp:270` — "open_.source = core::PositionSource::LocalGnss;"
- `gnss/src/nmea_receiver.cpp:266` — "close_epoch();"
...
- `gnss/src/nmea_receiver.cpp:475` — "core::elapsed(last_sentence_, now_) < silence_after_"
