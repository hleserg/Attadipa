...
[VERIFIED_FACTS.md:1555](VERIFIED_FACTS.md) "Waveshare memory: 32 MB flash, 8 MB PSRAM"
...
([OPEN_QUESTIONS.md:332](OPEN_QUESTIONS.md) "RESOLVED 2026-09-01 — take the facts, not the dependency"),
...
3. [VERIFIED_FACTS.md:650-651](VERIFIED_FACTS.md) "every part, pin, I2C" promises
