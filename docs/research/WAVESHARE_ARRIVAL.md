...
[VERIFIED_FACTS.md:1601](VERIFIED_FACTS.md) "Waveshare memory: 32 MB flash, 8 MB PSRAM"
...
([OPEN_QUESTIONS.md:360](OPEN_QUESTIONS.md) "RESOLVED 2026-09-01 — take the facts, not the dependency"),
...
([DEPENDENCIES.md:437](DEPENDENCIES.md) "Neither vendor BSP becomes a"). The
...
([`.github/workflows/ci.yml:949`](../../.github/workflows/ci.yml) "ESP32-S3 firmware build").
...
3. [VERIFIED_FACTS.md:696-697](VERIFIED_FACTS.md) "every part, pin, I2C" promises
