...
[VERIFIED_FACTS.md:1248](VERIFIED_FACTS.md) "Waveshare memory: 32 MB flash, 8 MB PSRAM"
...
this board ([OPEN_QUESTIONS.md:129](OPEN_QUESTIONS.md) "Waveshare: quad or octal?"),
and D12b, the T-Watch half, was then settled octal on a physical unit
([OPEN_QUESTIONS.md:130](OPEN_QUESTIONS.md) "RESOLVED 2026-08-27 — octal").
...
([OPEN_QUESTIONS.md:292](OPEN_QUESTIONS.md) "RESOLVED 2026-09-01 — take the facts, not the dependency"),
...
[OPEN_QUESTIONS.md:114](OPEN_QUESTIONS.md) "there is no expansion connector". This retires the hot-unplug and
...
1. HARDWARE_MATRIX called J3 an "Expansion connector … at least 29 pins", and D3
   ...
   [OPEN_QUESTIONS.md:114](OPEN_QUESTIONS.md) "there is no expansion connector".
