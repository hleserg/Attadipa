...
[VERIFIED_FACTS.md:1476](VERIFIED_FACTS.md) "Waveshare memory: 32 MB flash, 8 MB PSRAM"
...
([HARDWARE_MATRIX.md:406](HARDWARE_MATRIX.md) — "**not present**"). The only true reading of "not
...
this board ([OPEN_QUESTIONS.md:130](OPEN_QUESTIONS.md) "Waveshare: quad or octal?"),
and D12b, the T-Watch half, was then settled octal on a physical unit
([OPEN_QUESTIONS.md:131](OPEN_QUESTIONS.md) "RESOLVED 2026-08-27 — octal").
...
([OPEN_QUESTIONS.md:311](OPEN_QUESTIONS.md) "RESOLVED 2026-09-01 — take the facts, not the dependency"),
...
([DEPENDENCIES.md:408](DEPENDENCIES.md) "Neither vendor BSP becomes a"). The
...
([`.github/workflows/ci.yml:910`](../../.github/workflows/ci.yml) "ESP32-S3 firmware build").
...
[OPEN_QUESTIONS.md:115](OPEN_QUESTIONS.md) "there is no expansion connector". This retires the hot-unplug and
...
1. HARDWARE_MATRIX called J3 an "Expansion connector … at least 29 pins", and D3
   ...
   [OPEN_QUESTIONS.md:115](OPEN_QUESTIONS.md) "there is no expansion connector".
2. REUSE_LEDGER recorded the Waveshare BSP as coming from
   ...
   [REUSE_LEDGER.md:73](REUSE_LEDGER.md)
   "github.com/waveshareteam/Waveshare-ESP32-components".
3. [VERIFIED_FACTS.md:571-572](VERIFIED_FACTS.md) "every part, pin, I2C" promises
