...
([`.github/workflows/ci.yml:615`](../../.github/workflows/ci.yml) "ESP32-S3 firmware build").
...
`Amoled` ([`platform/src/board_profiles.cpp:126`](../../platform/src/board_profiles.cpp) "PanelTechnology::Amoled").
