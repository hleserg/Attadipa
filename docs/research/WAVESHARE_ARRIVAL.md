...
([`.github/workflows/ci.yml:632`](../../.github/workflows/ci.yml) "ESP32-S3 firmware build").
...
`Amoled` ([`platform/src/board_profiles.cpp:127`](../../platform/src/board_profiles.cpp) "PanelTechnology::Amoled").
