...
- **A correction this section used to make, withdrawn — it was wrong.** It read
  *"the document number of the Rev A datasheet is 13-52-25, not 13-52-27"*.
  ...
  [`VERIFIED_FACTS.md:1000`](VERIFIED_FACTS.md) "documents it fully" and
  [`VERIFIED_FACTS.md:1004`](VERIFIED_FACTS.md) "documents the identical feature".
...
```
  ...
  0x18 CHG_GAUGE_WDT  = 0x0A      0x93 ALDO2_VOLT     = 0x1C
