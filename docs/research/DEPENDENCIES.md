...
| **Pillow** | whatever the environment has | HPND (MIT-compatible) | tool-time only, for `tools/assets/` — authoring the source masks, the dimension cap, and the contact sheet |
