...
- **Source (this repository):** the single slot is
  ...
  [`firmware/main/meshcore_ble.cpp:2245`](../../firmware/main/meshcore_ble.cpp)
...
- **Condition — it is not unconditional:** the pairing this rests on happens
  ...
  [`firmware/main/meshcore_ble.cpp:1887`](../../firmware/main/meshcore_ble.cpp)
...
- **Source (this repository):** the watch is the central and takes that branch
  from [`firmware/main/meshcore_ble.cpp:1047`](../../firmware/main/meshcore_ble.cpp)
...
- **Source (this repository):** the refusal is
  ...
  is [`firmware/main/meshcore_ble.cpp:552`](../../firmware/main/meshcore_ble.cpp)
