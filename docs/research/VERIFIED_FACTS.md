...
- **Independently corroborated:** the same arithmetic puts `node_name` at offset
  ...
  `link/src/meshcore_companion.cpp:1224` — "(void)copy_text(status_.node_name, &data[58], size - 58);".
...
- **Source (this repository):** the single slot is
  ...
  [`firmware/main/meshcore_ble.cpp:2033`](../../firmware/main/meshcore_ble.cpp)
...
- **Condition — it is not unconditional:** the pairing this rests on happens
  ...
  [`firmware/main/meshcore_ble.cpp:1710`](../../firmware/main/meshcore_ble.cpp)
...
- **Consequence:** two comments said the gap would close with #356, which
  ...
  [`core/include/attadipa/core/mesh_service.h:104`](../../core/include/attadipa/core/mesh_service.h) "the way out, the entry screen's node field (#411)".
