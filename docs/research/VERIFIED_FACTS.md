...
- **Independently corroborated:** the same arithmetic puts `node_name` at offset
  ...
  `link/src/meshcore_companion.cpp:1261` — "(void)copy_text(status_.node_name, &data[58], size - 58);".
...
- **Consequence:** two comments said the gap would close with #356, which
  ...
  [`core/include/attadipa/core/mesh_service.h:108`](../../core/include/attadipa/core/mesh_service.h) "the way out, the entry screen's node field (#411)".
