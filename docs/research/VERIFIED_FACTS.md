...
- **Independently corroborated:** the same arithmetic puts `node_name` at offset
  ...
  `link/src/meshcore_companion.cpp:1348` — "(void)copy_text(status_.node_name, &data[58], size - 58);".
...
- **Source (this repository):** the single slot is
  ...
  [`firmware/main/meshcore_ble.cpp:2242`](../../firmware/main/meshcore_ble.cpp)
...
- **Condition — it is not unconditional:** the pairing this rests on happens
  ...
  ([`firmware/main/meshcore_ble.cpp:222`](../../firmware/main/meshcore_ble.cpp)
  "std::atomic_bool secure_pairing{false};", stored at
  [`firmware/main/meshcore_ble.cpp:1884`](../../firmware/main/meshcore_ble.cpp)
...
- **Source (this repository):** the watch is the central and takes that branch
  from [`firmware/main/meshcore_ble.cpp:1046`](../../firmware/main/meshcore_ble.cpp)
...
- **Source (this repository):** the refusal is
  ...
  is [`firmware/main/meshcore_ble.cpp:551`](../../firmware/main/meshcore_ble.cpp)
  "nvs_set_blob(handle, kNodeKeyNvsKey"; the file's one `nvs_erase_key` names
  the passkey instead —
  [`firmware/main/meshcore_ble.cpp:519`](../../firmware/main/meshcore_ble.cpp)
