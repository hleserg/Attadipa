...
[`VERIFIED_FACTS.md:2272`](VERIFIED_FACTS.md) "This entry used to name `13-52-25`" name one number or the other
...
| [`VERIFIED_FACTS.md:2268`](VERIFIED_FACTS.md) "values for that byte" | `REVISION_ID = 0x7C` comes from `13-52-25` |
...
the `0x7C` attribution at [`VERIFIED_FACTS.md:2264`](VERIFIED_FACTS.md)
