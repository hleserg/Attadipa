...
(`pedometer-bench-2026-08-28/probe/pedo.c:403` — "(hi[a] - lo[a]) * 1000"), and
no capture
...
(`pedometer-bench-2026-08-28/probe/pedo.c:195-225` —
...
`pedometer-bench-2026-08-28/probe/pedo.c:318-323` — "sample_cnt=%d" prints
...
[`VERIFIED_FACTS.md:2282`](VERIFIED_FACTS.md) "This entry used to name `13-52-25`" name one number or the other
...
| [`VERIFIED_FACTS.md:1000-1002`](VERIFIED_FACTS.md) "documents it fully" | `13-52-27` is QMI8658**C** Rev A, and it exists |
| [`VERIFIED_FACTS.md:1004-1006`](VERIFIED_FACTS.md) "documents the identical feature" | `13-52-25` is QMI8658**A** Rev A, and it exists too |
| [`VERIFIED_FACTS.md:2278`](VERIFIED_FACTS.md) "values for that byte" | `REVISION_ID = 0x7C` comes from `13-52-25` |
...
[`MAGNETOMETER_RETROFIT.md:154`](MAGNETOMETER_RETROFIT.md) "Admissible here as evidence" gives its md5. **What
...
the `0x7C` attribution at [`VERIFIED_FACTS.md:2274`](VERIFIED_FACTS.md)
...
[`MAGNETOMETER_RETROFIT.md:154`](MAGNETOMETER_RETROFIT.md) "Admissible here as evidence" already
