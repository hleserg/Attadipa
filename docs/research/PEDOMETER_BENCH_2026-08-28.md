...
[`VERIFIED_FACTS.md:2092`](VERIFIED_FACTS.md) "This entry used to name `13-52-25`" name one number or the other
...
| [`VERIFIED_FACTS.md:2088`](VERIFIED_FACTS.md) "values for that byte" | `REVISION_ID = 0x7C` comes from `13-52-25` |
...
the `0x7C` attribution at [`VERIFIED_FACTS.md:2084`](VERIFIED_FACTS.md)
