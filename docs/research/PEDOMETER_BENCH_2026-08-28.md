...
[`VERIFIED_FACTS.md:1925`](VERIFIED_FACTS.md) "This entry used to name `13-52-25`" name one number or the other
...
| [`VERIFIED_FACTS.md:816-818`](VERIFIED_FACTS.md) "documents it fully" | `13-52-27` is QMI8658**C** Rev A, and it exists |
| [`VERIFIED_FACTS.md:820-822`](VERIFIED_FACTS.md) "documents the identical feature" | `13-52-25` is QMI8658**A** Rev A, and it exists too |
| [`VERIFIED_FACTS.md:1921`](VERIFIED_FACTS.md) "values for that byte" | `REVISION_ID = 0x7C` comes from `13-52-25` |
...
the `0x7C` attribution at [`VERIFIED_FACTS.md:1917`](VERIFIED_FACTS.md)
