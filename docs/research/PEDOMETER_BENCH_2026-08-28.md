...
[`VERIFIED_FACTS.md:1752-1769`](VERIFIED_FACTS.md) "This entry used to name `13-52-25`" name one number or the other
...
| [`VERIFIED_FACTS.md:704-706`](VERIFIED_FACTS.md) "documents it fully" | `13-52-27` is QMI8658**C** Rev A, and it exists |
| [`VERIFIED_FACTS.md:708-710`](VERIFIED_FACTS.md) "documents the identical feature" | `13-52-25` is QMI8658**A** Rev A, and it exists too |
| [`VERIFIED_FACTS.md:1756`](VERIFIED_FACTS.md) "values for that byte" | `REVISION_ID = 0x7C` comes from `13-52-25` |
...
the `0x7C` attribution at [`VERIFIED_FACTS.md:1752`](VERIFIED_FACTS.md)
