...
[`firmware/main/waveshare_board.cpp:733`](../../firmware/main/waveshare_board.cpp) —
"initialize AXP2101", through
[`firmware/main/waveshare_board.cpp:747`](../../firmware/main/waveshare_board.cpp) —
...
are equal; the id space exhausted is `Exhausted` with no count moved.
