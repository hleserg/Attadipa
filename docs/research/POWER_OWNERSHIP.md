...
[`firmware/main/waveshare_board.cpp:1422`](../../firmware/main/waveshare_board.cpp) —
...
([`firmware/main/waveshare_board.cpp:1497`](../../firmware/main/waveshare_board.cpp) —
...
([`firmware/main/waveshare_board.cpp:1564`](../../firmware/main/waveshare_board.cpp) —
...
[`firmware/main/waveshare_board.cpp:1548`](../../firmware/main/waveshare_board.cpp) —
"lv_obj_remove_event_cb(lv_screen_active(), long_press);" — removes the path
into provisioning/RTC,
[`firmware/main/waveshare_board.cpp:1551`](../../firmware/main/waveshare_board.cpp) —
...
([`firmware/main/waveshare_board.cpp:1061`](../../firmware/main/waveshare_board.cpp) —
...
released ([`firmware/main/waveshare_board.cpp:1410`](../../firmware/main/waveshare_board.cpp) —
