...
[`firmware/main/waveshare_board.cpp:1375`](../../firmware/main/waveshare_board.cpp) —
...
[`firmware/main/waveshare_board.cpp:1487`](../../firmware/main/waveshare_board.cpp) —
"lv_obj_remove_event_cb(lv_screen_active(), long_press);" — removes the path
into provisioning/RTC,
[`firmware/main/waveshare_board.cpp:1489`](../../firmware/main/waveshare_board.cpp) —
...
[`firmware/main/waveshare_board.cpp:1495`](../../firmware/main/waveshare_board.cpp) —
...
([`firmware/main/waveshare_board.cpp:1032`](../../firmware/main/waveshare_board.cpp) —
...
released ([`firmware/main/waveshare_board.cpp:1353`](../../firmware/main/waveshare_board.cpp) —
