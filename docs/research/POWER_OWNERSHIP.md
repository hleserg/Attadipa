...
[`OPEN_QUESTIONS.md:134`](OPEN_QUESTIONS.md) — "**ALDO1** (3.3 V) = net". The
...
[`OPEN_QUESTIONS.md:134`](OPEN_QUESTIONS.md) — "**ALDO1** (3.3 V) = net"; not
...
[`OPEN_QUESTIONS.md:129`](OPEN_QUESTIONS.md) — "must never be driven as an output"
makes for GPIO 6.
