...
[`OPEN_QUESTIONS.md:132`](OPEN_QUESTIONS.md) — "**ALDO1** (3.3 V) = net". The
...
the tree — now
[`firmware/main/board_power.cpp:503`](../../firmware/main/board_power.cpp) —
...
[`firmware/main/board_power.cpp:699`](../../firmware/main/board_power.cpp) —
"DC1 3.3 V", then ALDO1 and
[`firmware/main/board_power.cpp:701`](../../firmware/main/board_power.cpp) —
"ALDO2 3.3 V", enabling them read-modify-write at
[`firmware/main/board_power.cpp:708`](../../firmware/main/board_power.cpp) —
"ESP_RETURN_ON_ERROR(write_reg(pmu, 0x90, aldo | 0x03), kTag,". Its comment
states the discipline it is keeping —
[`firmware/main/board_power.cpp:697`](../../firmware/main/board_power.cpp) —
...
`core/include/attadipa/core/node_link_lease.h:124` — "class NodeLinkLease {".
...
now [`firmware/main/board_power.cpp:376`](../../firmware/main/board_power.cpp) —
...
one source — [`firmware/main/board_power.cpp:418`](../../firmware/main/board_power.cpp) —
...
[`firmware/main/board_power.cpp:533`](../../firmware/main/board_power.cpp) —
"gpio_get_level(hw.touch_interrupt_) != 0) {". ESP-IDF's own header says of the
...
[`firmware/main/waveshare_board.cpp:1448`](../../firmware/main/waveshare_board.cpp) —
...
[`firmware/main/twatch_board.cpp:826`](../../firmware/main/twatch_board.cpp) —
...
([`firmware/main/waveshare_board.cpp:1624`](../../firmware/main/waveshare_board.cpp) —
...
([`firmware/main/waveshare_board.cpp:1691`](../../firmware/main/waveshare_board.cpp) —
...
[`firmware/main/waveshare_board.cpp:1675`](../../firmware/main/waveshare_board.cpp) —
"lv_obj_remove_event_cb(lv_screen_active(), long_press);" — removes the path
into provisioning/RTC,
[`firmware/main/waveshare_board.cpp:1678`](../../firmware/main/waveshare_board.cpp) —
...
[`firmware/main/waveshare_board.cpp:1684`](../../firmware/main/waveshare_board.cpp) —
...
([`firmware/main/waveshare_board.cpp:1077`](../../firmware/main/waveshare_board.cpp) —
...
released ([`firmware/main/waveshare_board.cpp:1426`](../../firmware/main/waveshare_board.cpp) —
...
[`firmware/main/board_power.cpp:574`](../../firmware/main/board_power.cpp) —
...
(`core/include/attadipa/core/node_link_lease.h:100` — "return phase == TransportPhase::Attached");
...
[`OPEN_QUESTIONS.md:132`](OPEN_QUESTIONS.md) — "**ALDO1** (3.3 V) = net"; not
...
[`OPEN_QUESTIONS.md:127`](OPEN_QUESTIONS.md) — "must never be driven as an output"
makes for GPIO 6.
...
[`firmware/main/wake_classification.h:74`](../../firmware/main/wake_classification.h) —
