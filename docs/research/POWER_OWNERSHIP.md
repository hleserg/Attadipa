...
the tree — now
[`firmware/main/board_power.cpp:498`](../../firmware/main/board_power.cpp) —
...
[`firmware/main/board_power.cpp:679`](../../firmware/main/board_power.cpp) —
"DC1 3.3 V", then ALDO1 and
[`firmware/main/board_power.cpp:681`](../../firmware/main/board_power.cpp) —
"ALDO2 3.3 V", enabling them read-modify-write at
[`firmware/main/board_power.cpp:688`](../../firmware/main/board_power.cpp) —
"ESP_RETURN_ON_ERROR(write_reg(pmu, 0x90, aldo | 0x03), kTag,". Its comment
states the discipline it is keeping —
[`firmware/main/board_power.cpp:677`](../../firmware/main/board_power.cpp) —
...
[`firmware/main/board_power.cpp:511`](../../firmware/main/board_power.cpp) —
...
[`firmware/main/waveshare_board.cpp:1455`](../../firmware/main/waveshare_board.cpp) —
...
[`firmware/main/waveshare_board.cpp:1445`](../../firmware/main/waveshare_board.cpp) —
...
([`firmware/main/waveshare_board.cpp:1631`](../../firmware/main/waveshare_board.cpp) —
...
([`firmware/main/waveshare_board.cpp:1698`](../../firmware/main/waveshare_board.cpp) —
...
[`firmware/main/waveshare_board.cpp:1682`](../../firmware/main/waveshare_board.cpp) —
"lv_obj_remove_event_cb(lv_screen_active(), long_press);" — removes the path
into provisioning/RTC,
[`firmware/main/waveshare_board.cpp:1685`](../../firmware/main/waveshare_board.cpp) —
...
([`firmware/main/waveshare_board.cpp:1084`](../../firmware/main/waveshare_board.cpp) —
...
released ([`firmware/main/waveshare_board.cpp:1433`](../../firmware/main/waveshare_board.cpp) —
...
[`firmware/main/board_power.cpp:554`](../../firmware/main/board_power.cpp) —
