...
the tree — now
[`firmware/main/board_power.cpp:468`](../../firmware/main/board_power.cpp) —
...
[`firmware/main/board_power.cpp:649`](../../firmware/main/board_power.cpp) —
"DC1 3.3 V", then ALDO1 and
[`firmware/main/board_power.cpp:651`](../../firmware/main/board_power.cpp) —
"ALDO2 3.3 V", enabling them read-modify-write at
[`firmware/main/board_power.cpp:658`](../../firmware/main/board_power.cpp) —
"ESP_RETURN_ON_ERROR(write_reg(pmu, 0x90, aldo | 0x03), kTag,". Its comment
states the discipline it is keeping —
[`firmware/main/board_power.cpp:647`](../../firmware/main/board_power.cpp) —
...
now [`firmware/main/board_power.cpp:362`](../../firmware/main/board_power.cpp) —
...
one source — [`firmware/main/board_power.cpp:404`](../../firmware/main/board_power.cpp) —
...
[`firmware/main/board_power.cpp:481`](../../firmware/main/board_power.cpp) —
"const std::uint32_t soc = esp_sleep_get_wakeup_causes();" — and the pin is a
corroborating signal that only logs a warning:
[`firmware/main/board_power.cpp:492`](../../firmware/main/board_power.cpp) —
