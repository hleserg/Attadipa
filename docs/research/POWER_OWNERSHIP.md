...
[`firmware/main/waveshare_board.cpp:1319`](../../firmware/main/waveshare_board.cpp) —
...
[`firmware/main/waveshare_board.cpp:1309`](../../firmware/main/waveshare_board.cpp) —
...
([`firmware/main/waveshare_board.cpp:1383`](../../firmware/main/waveshare_board.cpp) —
...
[`firmware/main/waveshare_board.cpp:1431`](../../firmware/main/waveshare_board.cpp) —
"lv_obj_remove_event_cb(lv_screen_active(), long_press);" — removes the path
into provisioning/RTC,
[`firmware/main/waveshare_board.cpp:1433`](../../firmware/main/waveshare_board.cpp) —
...
([`firmware/main/waveshare_board.cpp:1010`](../../firmware/main/waveshare_board.cpp) —
...
released ([`firmware/main/waveshare_board.cpp:1297`](../../firmware/main/waveshare_board.cpp) —
