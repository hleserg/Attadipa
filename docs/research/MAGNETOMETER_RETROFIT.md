...
3. **The simulator cannot reach the new states, and the `--radio` precedent does
   not transfer.** `sim/options.cpp:433` — "    out.board.radio = platform::radio_info_for(radio);" — writes a field
