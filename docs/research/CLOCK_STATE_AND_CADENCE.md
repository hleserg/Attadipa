...
definition.** `sim/main.cpp:275` — "core::Capability::Time" — already lists
...
| Adult/Child | **yes** — `--child` | [`sim/options.cpp:171`](../../sim/options.cpp) — "out.child_mode = true;", rendered at [`sim/main.cpp:386`](../../sim/main.cpp) — "apps::ClockMode::Child" |
| a specific time | **yes** — `--clock-time <unix seconds>` | [`sim/options.cpp:182`](../../sim/options.cpp) — "out.clock_time_set = true;", consumed at [`sim/main.cpp:364`](../../sim/main.cpp) — "g_clock_live = !options.clock_time_set" |
