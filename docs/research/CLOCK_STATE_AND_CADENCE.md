...
[`sim/options.cpp:172`](../../sim/options.cpp) — "out.child_mode = true;" and
[`sim/options.cpp:183`](../../sim/options.cpp) — "out.clock_time_set = true;"; and the tick period
...
definition.** `sim/main.cpp:100` — "core::Capability::Time" — already lists
...
| Adult/Child | **yes** — `--child` | [`sim/options.cpp:172`](../../sim/options.cpp) — "out.child_mode = true;", rendered at [`sim/main.cpp:201`](../../sim/main.cpp) — "apps::ClockMode::Child" |
| a specific time | **yes** — `--clock-time <unix seconds>` | [`sim/options.cpp:183`](../../sim/options.cpp) — "out.clock_time_set = true;", consumed at [`sim/main.cpp:203`](../../sim/main.cpp) — "!options.clock_time_set" and passed to `build_clock_screen` as its `live` argument |
