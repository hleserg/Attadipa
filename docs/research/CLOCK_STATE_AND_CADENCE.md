...
| Adult/Child | **yes** — `--child` | [`sim/options.cpp:152`](../../sim/options.cpp) — "out.child_mode = true;", rendered at [`sim/main.cpp:354`](../../sim/main.cpp) — "apps::ClockMode::Child" |
| a specific time | **yes** — `--clock-time <unix seconds>` | [`sim/options.cpp:163`](../../sim/options.cpp) — "out.clock_time_set = true;", consumed at [`sim/main.cpp:333`](../../sim/main.cpp) — "g_clock_live = !options.clock_time_set" |
...
| screenshot | **yes**, but the **first frame only** | `sim/main.cpp:445` — "if (options.screenshot != nullptr)" — takes the snapshot, then the frame loop runs |
