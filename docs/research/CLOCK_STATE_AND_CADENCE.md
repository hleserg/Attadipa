...
[`sim/options.cpp:203`](../../sim/options.cpp) — "out.child_mode = true;" and
[`sim/options.cpp:214`](../../sim/options.cpp) — "out.clock_time_set = true;"; and the tick period
...
| node attached / detached | **yes** — `--node` | `sim/options.cpp:143-146` — "out.node_attached = true;" |
