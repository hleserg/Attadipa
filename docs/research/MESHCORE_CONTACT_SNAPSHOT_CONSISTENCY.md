...
fact into a semantic claim — `link/src/meshcore_companion.cpp:1520` —
...
6. Every other valid push — including all four invalidating ones — reaches the
   ...
   `link/src/meshcore_companion.cpp:1907` — "// A response code this build does not know is a frame we did not".
