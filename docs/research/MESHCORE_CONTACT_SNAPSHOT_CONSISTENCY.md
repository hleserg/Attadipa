...
fact into a semantic claim — `link/src/meshcore_companion.cpp:1490` —
...
6. Every other valid push — including all four invalidating ones — reaches the
   ...
   `link/src/meshcore_companion.cpp:1851` — "// A response code this build does not know is a frame we did not".
