...
> key beside the name:
> `apps/include/attadipa/apps/mesh.h:144` — "// Four bytes of a node's public key as hex, into a nine-byte buffer."
...
> `link/src/meshcore_companion.cpp:1312` — "        // THE COORDINATE, AND ONLY FROM A NODE THIS WATCH ACCEPTED. Every"
