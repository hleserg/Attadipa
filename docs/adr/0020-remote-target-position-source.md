...
148 — `link/src/meshcore_companion.cpp:1433` — "        if (size < 148) { ++malformed_frames_; return false; }" —
...
`link/src/meshcore_companion.cpp:1573` — "        accept_custom_vars(&data[1], size - 1);" — and an arm
