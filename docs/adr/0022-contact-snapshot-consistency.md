...
`link/src/meshcore_companion.cpp:1490` — "status_.peers_complete = true;" is set
...
frame it loses — `link/src/meshcore_companion.cpp:512` — "            status_.peers_complete = true;".
...
both completion flags — `link/src/meshcore_companion.cpp:1409` — "        peer_count_ = 0;".
