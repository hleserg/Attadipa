...
`link/src/meshcore_companion.cpp:1405` — "status_.peers_complete = true;" is set
...
frame it loses — `link/src/meshcore_companion.cpp:476` — "            status_.peers_complete = true;".
...
both completion flags — `link/src/meshcore_companion.cpp:1373` — "        peer_count_ = 0;".
