...
`link/src/meshcore_companion.cpp:1301` — "status_.peers_complete = true;" is set
...
frame it loses — `link/src/meshcore_companion.cpp:430` — "            status_.peers_complete = true;".
...
both completion flags — `link/src/meshcore_companion.cpp:1278` — "        peer_count_ = 0;".
