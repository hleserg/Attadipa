...
`link/src/meshcore_companion.cpp:1413` — "status_.peers_complete = true;" is set
...
frame it loses — `link/src/meshcore_companion.cpp:470` — "            status_.peers_complete = true;".
...
both completion flags — `link/src/meshcore_companion.cpp:1367` — "        peer_count_ = 0;".
