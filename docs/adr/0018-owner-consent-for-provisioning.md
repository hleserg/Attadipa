...
`docs/research/VERIFIED_FACTS.md:1405` — "button presses arrive as PMU interrupts"
...
`docs/research/VERIFIED_FACTS.md:1404` — "- **Source:** S3 sheet 1." — and its
...
- There is one bond slot, and it is spoken for.
  ...
  `docs/research/VERIFIED_FACTS.md:546` — "### A wrong MeshCore node's bond evicts the pinned node's",
...
- **Both interfaces exist and are the right shape, and a product image
  ...
  `firmware/main/meshcore_ble.h:21` — "bool configure_meshcore_ble(std::uint32_t passkey);"
