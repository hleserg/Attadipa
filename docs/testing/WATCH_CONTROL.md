...
(`waveshare_board.cpp:878` "restore_time_metadata()") is outside the `#if` — but
...
`BoardMeshSink::configure` (`waveshare_board.cpp:494`
...
"std::atomic_bool mesh_screen_requested") is set only at `waveshare_board.cpp:497`
