...
(`waveshare_board.cpp:840` "restore_time_metadata()") is outside the `#if` — but
...
`BoardMeshSink::configure` (`waveshare_board.cpp:456`
...
"std::atomic_bool mesh_screen_requested") is set only at `waveshare_board.cpp:459`
