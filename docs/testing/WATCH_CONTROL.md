...
that sets either of them **true** (`meshcore_ble.cpp:923`
"configured.store(true)", `meshcore_ble.cpp:924`
"reconnect_allowed.store(true)" — every other write clears them), and
`start_scan()` returns unless both are true (`meshcore_ble.cpp:224`
