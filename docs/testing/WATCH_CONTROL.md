...
(`waveshare_board.cpp:753` "restore_time_metadata()") is outside the `#if` — but
...
`BoardMeshSink::configure` (`waveshare_board.cpp:369`
...
"std::atomic_bool mesh_screen_requested") is set only at `waveshare_board.cpp:372`
