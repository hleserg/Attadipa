...
(`waveshare_board.cpp:861` "restore_time_metadata()") is outside the `#if` — but
...
`BoardMeshSink::configure` (`waveshare_board.cpp:477`
...
"std::atomic_bool mesh_screen_requested") is set only at `waveshare_board.cpp:480`
