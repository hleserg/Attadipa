...
`BoardMeshSink::configure` (`waveshare_board.cpp:538`
...
(`waveshare_board.cpp:487` "return configure_meshcore_ble(passkey)") is the
...
"std::atomic_bool mesh_screen_requested") is set only at `waveshare_board.cpp:541`
