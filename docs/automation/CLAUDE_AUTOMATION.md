...
that describes a protection the code does not apply is the finding blocking
[#154](https://github.com/hleserg/Attadipa/pull/154). Neither is better than a
sweep that says, 48 times a day, exactly what it needs.
