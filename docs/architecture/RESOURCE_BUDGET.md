...
`docs/research/OPEN_QUESTIONS.md:131` — "RESOLVED 2026-08-27 — octal".
...
`lvgl@85aa60d1`, and
`sim/lv_conf_simulator.h:218` "LV_DRAW_SW_SUPPORT_RGB565_SWAPPED       1"
compiles it in.
...
`sim/lv_conf_simulator.h:212` "Selectively disable color format support in order to reduce code size",
...
`sim/debug_server.cpp:760` — "std::uint8_t chunk[4096];" — puts it on the stack and calls
